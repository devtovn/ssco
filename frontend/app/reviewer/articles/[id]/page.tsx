...
export default function ReviewerArticleEditPage() {
  ...
  if (!article) {
    return (
      <div>
        ...
        <Link href="/reviewer" className="mt-4 inline-block text-primary-600 hover:underline">
          ← Quay lại
        </Link>
      </div>
    );
  ...
  return (
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <Link href="/reviewer/pending" className="text-sm text-primary-600 hover:underline">
          Danh sách chờ duyệt
        </Link>
      </div>
